            ...
            <div class="card-header ui-sortable-handle" style="cursor: move;">
                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        ...
                        <li class="nav-item mr-1">
                            <button class="btn btn-sm btn-primary" @click="getAdmin()"><i class="fas fa-user-plus"></i> Admins </button>
                        </li>

                        <li class="nav-item mr-1">
                            <button class="btn btn-sm btn-primary" @click="getCustomer()"><i class="fas fa-users"></i> Customers  </button>
                        </li>
                        <li class="nav-item mr-1">
